  ...
  return (
    <div className="page__products">
      <div className="container-fluid page__products_promotion">
        ...
        >
          <SwiperSlide>
            ร้านเชียงใหม่ท่อพัก ลดราคาลง 10% ฉลองปี 2022
          </SwiperSlide>
          <SwiperSlide>โปรโมชั่นหม้อเลสสายซิ่งเริ่มที่ 2,500-3,200</SwiperSlide>
          <SwiperSlide>เอาใจสายไทเทเนียมเริ่มต้นที่ 3,300-3,800</SwiperSlide>
          <SwiperSlide>พักกลางเลสเน้นเก็บเสียงราคาอยู่ที่ 2,500</SwiperSlide>
        </Swiper>
      </div>
